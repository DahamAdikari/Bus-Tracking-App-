...
class OnBoardingScreenNew extends StatefulWidget {
  OnBoardingScreenNew({super.key});

  @override
  State<OnBoardingScreenNew> createState() => _OnBoardingScreenState();
}

class _OnBoardingScreenState extends State<OnBoardingScreenNew> {
